...
from engine_finetune_single import evaluate
...
def get_args_parser():
    parser = argparse.ArgumentParser('PMIL Evaluation', add_help=False)
    ...
    parser.add_argument('--resnet_path', type=str, default='/raid5/chr/AIGCD/AIDE/results/AIDE-Original-progan/checkpoint-1.pth')
...
def main(args):
    ...
    if len(vals) >= 16:
        ...
        csv_name = os.path.join(args.output_dir, 'eval_results.csv')
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('PMIL Evaluation', parents=[get_args_parser()])
