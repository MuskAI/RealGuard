...
# added by haoran
import models.PMIL_SRM as PMIL
##########################
import csv
import warnings
...
from mil_loss import DualLevelCELoss
...
def get_args_parser():
    ...
    parser.add_argument('--output_dir', default='/raid5/chr/AIGCD/AIDE/results/MIL-SRM-Dual-dv1_4',
